...
namespace CourseLibrary.API.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        //actionResult return Type no contiene ningún tipo.
        public IActionResult UpdateCourseForAuthor(Guid authorId, Guid courseId, CourseForUpdateDto course)
        {
            ...
            //map la entidad a courseForUpdateDto
            //aplicar la actualización a los valores de los campos en el dto
            //mapear el courseForDto a la entidad
            ...
            JsonPatchDocument<CourseForUpdateDto> patchDocument)
        {
            ...
            if (courseForAuthorFromRepo == null)
            {
                ...
                if (!TryValidateModel(courseDto)) //que pasa aquí?
                {
